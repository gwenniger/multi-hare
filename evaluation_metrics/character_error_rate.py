...
def character_error_rate_list_of_output_reference_pairs(symbol_list_outputs: list, symbol_list_references: list):
    """
    ...
    for symbol_list_output, symbol_list_reference in zip(symbol_list_outputs, symbol_list_references):
        distance = ld.levenshtein_distance(symbol_list_output, symbol_list_reference)
        print("distance = " + str(distance))
        reference_length = len(symbol_list_reference)
        print("reference_length: " + str(reference_length))
...
def test_character_error_rate_list_of_output_reference_pairs(
    ...
    cer = character_error_rate_list_of_output_reference_pairs(outputs_as_char_lists, references_as_char_lists)
